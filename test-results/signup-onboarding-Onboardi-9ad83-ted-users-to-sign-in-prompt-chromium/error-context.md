...
- Name: signup-onboarding.spec.ts >> Onboarding page (auth gating) >> redirects unauthenticated users to sign-in prompt
- Location: tests\e2e\signup-onboarding.spec.ts:96:7
